...
K_PLUGIN_FACTORY_WITH_JSON(
    // BreezeDecoFactory,
    BreezeArcDecoFactory,
    "breeze.json",
    registerPlugin<ArcBreeze::Decoration>();
    registerPlugin<ArcBreeze::Button>(QStringLiteral("button"));
    registerPlugin<ArcBreeze::ConfigWidget>(QStringLiteral("kcmodule"));
)
